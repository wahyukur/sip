                            ...
                            <td>
                                <form action="{{ route('kegiatan.destroy', $datas->id_kegiatan) }}" method="post">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a href="#" class=" btn btn-sm btn-success" data-toggle="tooltip" title="Cetak Absen"><span class="glyphicon glyphicon-print"></span></a>
                                        <a href="#" class=" btn btn-sm btn-info" data-toggle="tooltip" title="Tidak Hadir"><span class="glyphicon glyphicon-minus-sign"></span></a>
                                    </div>
