		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<form class="form-horizontal" method="post" action="{{ route('kader.update', $datas->id_kader) }}">
						@csrf
							...
							<div class="row">
								...
								<div class="input-group col-md-8">
									<div class="input-group">
										...
										<input type="text" class="form-control" placeholder="Nama Kader" name="nama_kader" value="{{ $datas->nama_kader }}" required>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="input-group col-md-8">
									<div class="input-group">
										...
										<input type="number" class="form-control" placeholder="Nomor Telpon" name="no_telp" value="{{ $datas->no_telp }}" required>
									</div>
								</div>
							</div>
						</div>
